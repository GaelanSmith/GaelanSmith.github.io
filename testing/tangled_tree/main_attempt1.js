...
// import define1 from "./5cd5cb7ccc2b790f@200.js";
...
(data, options={}) => {
  ...
  ${tangleLayout.nodes.map(
    ...
    <text x="${n.x + 4}" y="${n.y -
      n.height / 2 -
      4}" style="pointer-events: none;">${n.name}</text>
  `
  )}
...
[
  [{ id: '1', name: 'Chaos' }],
  [{ id: '2', name: 'Gaea', parents: ['1'] }, { id: '3', name: 'Uranus' }],
  [
    { id: '4', name:'Oceanus', parents: ['2', '3'] },
    { id: '5', name: 'Thethys', parents: ['2', '3'] },
    { id: '6', name: 'Pontus' },
    { id: '7', name: 'Rhea', parents: ['2', '3'] },
    { id: '8', anme: 'Cronus', parents: ['2', '3'] },
    { id: '9', name: 'Coeus', parents: ['2', '3'] },
    { id: '10', name: 'Phoebe', parents: ['2', '3'] }
  ],
  [
    { id: '11', name: 'Doris', parents: ['4', '5'] },
    { id: '12', name: 'Neures', parents: ['6', '2'] },
    { id: '13', name: 'Dionne' },
    { id: '14', name: 'Demeter', parents: ['7', '8'] },
    { id: '15', name: 'Hades', parents: ['7', '8'] },
    { id: '16', name: 'Hera', parents: ['7', '8'] },
    { id: '17', name: 'Alcmene' },
    { id: '18', name: 'Zeus', parents: ['7', '8'] },
    { id: '19', name: 'Eris' },
    { id: '20', name: 'Leto', parents: ['9', '10'] },
    { id: '21', name: 'Amphitrite' },
    { id: '22', name: 'Medusa' },
    { id: '23', name: 'Poseidon', parents: ['7', '8'] },
    { id: '24', name: 'Hestia', parents: ['7', '8'] }
  ],
  [
    { id: '25', name: 'Thetis', parents: ['11', '12'] },
    { id: '26', name: 'Peleus' },
    { id: '27', name: 'Anchises' },
    { id: '28', name: 'Adonis' },
    { id: '29', name: 'Aphrodite', parents: ['18', '13'] },
    { id: '30', name: 'Persephone', parents: ['18', '14'] },
    { id: '31', name: 'Ares', parents: ['18', '16'] },
    { id: '32', name: 'Hephaestus', parents: ['18', '16'] },
    { id: '33', name: 'Leda' }
  ],
  [
    { id: '34', name: 'Deidamia' },
    { id: '35', name: 'Achilles', parents: ['26', '25'] },
    { id: '36', name: 'Creusa' },
    { id: '37', name: 'Aeneas', parents: ['27', '29'] },
    { id: '38', name: 'Lavinia' },
    { id: '39', name: 'Eros', parents: ['32', '29'] },
    { id: '40', name: 'Helen', parents: ['33', '18'] },
    { id: '41', name: 'Menelaus' },
    { id: '42', name: 'Polydueces', parents: ['33', '18'] }
  ]
]
)}
